...
Usage:
    ...
    python3 relay_blip.py --address 0x11 --hold-seconds 8 --confirm
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--hold-seconds", type=float, default=DEFAULT_HOLD_SECONDS, help=f"seconds to hold relay ON (default: {DEFAULT_HOLD_SECONDS:.0f})"
    )
    parser.add_argument(
